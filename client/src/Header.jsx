    ...
    <div>
      <header className="flex justify-between">
        ...
        <div className="flex gap-2 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-300">
          <div >Any Where</div>
          <div className="border border-r-3"></div>
          <div>Any Week</div>
          <div className="border border-r-3"></div>
          <div>Any guests</div>
        ...
        <Link to={user? '/account': '/login'} className="flex items-center gap-2 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-300">
          ...
          <div className="overflow-hidden">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 bg-gray-500 text-white rounded-full relative">
